...
$_sqlObj->query('INSERT INTO `address` (`id`, `datetime`, `userId`, `srId`, `bidId`, `personal`, `pob`, `orderNum`, `title`, `descr`, `address`, `posLong`, `posLat`, `country`, `notes`) VALUES (NULL, $today, $id, NULL, NULL, NULL, NULL, NULL, NULL, NULL, $post[addr], NULL, NULL, NULL, NULL)');
