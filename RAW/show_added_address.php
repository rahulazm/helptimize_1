...
$today=date("Y-m-d");
echo $sql_get_sr_addresses = "SELECT * FROM address WHERE userId='".$_SESSION['id']."' and personal IS NULL and bidId is NULL and srId is null and (pob is null or pob=0)";
