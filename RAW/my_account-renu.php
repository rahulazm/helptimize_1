...
<div class="form-group">
      <label for="usr"><font color="black"><?php echo COMPANY_NAME;?><?font></label>
...
<div class="form-group">
      ...
      <div class="form-group">
              <label for="usr"><font color="black"><?php echo ZIP;?><?font></label>
...
<div class="form-group">
            <label for="usr"><font color="black"><?php echo CITY;?><?font></label>
...
<div class="form-group">
              <label for="usr"><font color="black"><?php echo STATE;?><?font></label>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_2" href="#collapseTwo">
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_6" href="#collapseTwo1">
          Checkr Verification
        </a>
      </h4>
    </div>
    ...
    <div id="collapseTwo1" class="panel-collapse collapse out">
      <div class="panel-body">
      <?php
      ...
      <div class="form-group">
              <label for="usr"><font color="black">SSN#</font></label>
              <br>
  ...
  <div class="form-group">
          <label for="usr"><font color="black">Zip Code</font></label>
...
<?php /*} else{
  ...
  <!-- <div class="panel-group" id="accordion_3" name="accordion_3">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_3" href="#collapseTree">
          <?php echo DOCUMENT_VERIFICATION?>
        </a>
      </h4>
    </div>
    ...
    <div id="collapseTree" class="panel-collapse collapse out">
      ...
      if($row_cnt_verified_documents > 0){
      ...
      <table id="verified_document" class="table table-striped table-bordered" cellspacing="0" width="100%">
          ...
          <?php
           ...
           while ($row = $result_get_verified_documents->fetch_assoc()) {
           ?>
           <tr>
 ...
 <div class="panel-group" id="accordion_5" name="accordion_5">
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_5" href="#collapseFive">
          <?php echo DOCUMENT_VERIFICATIONS?>
        </a>
      </h4>
    </div>
...
while ($row = $document->fetch_assoc()) {
 ...
 <div class="panel-group" id="accordion_4" name="accordion_4" >
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion_4" href="#collapseFour">
          <?php echo SERVICE_PROVIDED_AREAS?>
        </a>
      </h4>
    </div>
