...
$sql_insert_service_request_address = "INSERT INTO address ( userId,srId, datetime, title, descr, address, posLong, posLat) VALUES ( '".$_SESSION['id']."', '".$_POST['srId']."', now(), '".$_POST['name']."', '".$_POST['description']."', '".$_POST['address']."', '".$_POST['longitude']."', '".$_POST['latitude']."')";
